...
public abstract class AbstractControllerIntegrationTest extends AbstractIntegrationTest {
    ...
    protected static final String GET_CHAT_REACTIONS_API_URL = "/chats/%s/reactions";
    ...
    protected static final String GET_REACTIONS_BY_MESSAGE_ID = "/chats/%s/messages/%s/reactions/users";
